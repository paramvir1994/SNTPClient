...
public class NtpMessage {
	 ...
	 * inserted/deleted in the last minute of the current day. It's values may be as
	 * follows:
	 * 
	 * Value Meaning ----- ------- 0 no warning 1 last minute has 61 seconds 2 last
	 * minute has 59 seconds) 3 alarm condition (clock not synchronized)
	 */
	public byte leapIndicator = 0;

	/**
	 * This value indicates the NTP/SNTP version number. The version number is 3 for
	 * Version 3 (IPv4 only) and 4 for Version 4 (IPv4, IPv6 and OSI). If necessary
	 * to distinguish between IPv4, IPv6 and OSI, the encapsulating context must be
	 * inspected.
	 */
	 ...
	 * 
	 * Mode Meaning ---- ------- 0 reserved 1 symmetric active 2 symmetric passive 3
	 * client 4 server 5 broadcast 6 reserved for NTP control message 7 reserved for
	 * private use
	 * 
	 * In unicast and anycast modes, the client sets this field to 3 (client) in the
	 * request and the server sets it to 4 (server) in the reply. In multicast mode,
	 * the server sets this field to 5 (broadcast).
	 */
	public byte mode = 0;
	 ...
	 * or unavailable 1 primary reference (e.g., radio clock) 2-15 secondary
	 ...
	 * seconds to the nearest power of two. The values that can appear in this field
	 * presently range from 4 (16 s) to 14 (16284 s); however, most applications use
	 ...
	 * source, in seconds. The values that normally appear in this field range from
	 * 0 to several hundred milliseconds.
	 */
	 ...
	 * external means of synchronization PPS atomic clock or other pulse-per-second
	 * source individually calibrated to national standards ACTS NIST dialup modem
	 * service USNO USNO modem service PTB PTB (Germany) modem service TDF Allouis
	 * (France) Radio 164 kHz DCF Mainflingen (Germany) Radio 77.5 kHz MSF Rugby
	 * (UK) Radio 60 kHz WWV Ft. Collins (US) Radio 2.5, 5, 10, 15, 20 MHz WWVB
	 * Boulder (US) Radio 60 kHz WWVH Kaui Hawaii (US) Radio 2.5, 5, 10, 15 MHz CHU
	 * Ottawa (Canada) Radio 3330, 7335, 14670 kHz LORC LORAN-C radionavigation
	 * system OMEG OMEGA radionavigation system GPS Global Positioning Service GOES
	...
	/**
	 * This is the time at which the request arrived at the server, in seconds since
	 * 00:00 1-Jan-1900.
	 */
	...
	/**
	 * Converts an unsigned byte to a short. By default, Java assumes that a byte is
	 * signed.
	 */
	...
	/**
	 * Returns a timestamp (number of seconds since 00:00 1-Jan-1900) as a formatted
	 * date/time string.
	 */
	...
	public static String referenceIdentifierToString(byte[] ref, short stratum, byte version) {
		...
		// of the latest transmit timestamp of the reference source.
			...
			return "" + ((unsignedByteToShort(ref[0]) / 256.0) + (unsignedByteToShort(ref[1]) / 65536.0)
